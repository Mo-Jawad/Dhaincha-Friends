...
function StudentDetails() {
  ...
  return (
    <div className=' h-[35rem] w-full p-4 pt-8 bg-gray-700 items-center'>
      ...
      <Link className='p-3 px-5 hover:text-white transition-colors duration-200 bg-amber-400 rounded-md hover:bg-gray-700 hover:border-orange-400 border-2 font-bold border-gray-700' to="/">Home</Link>
      </div>
