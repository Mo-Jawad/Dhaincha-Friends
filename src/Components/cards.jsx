...
const Cards = ({ filteredUsers}) => {
    return (
            ...
            
        {
            filteredUsers.map(dhaicha =>
                ...
                <div key={dhaicha.id} className="w-full max-w-xs overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 p-3 hover:scale-105 transition-transform hover:shadow-2xl hover:shadow-green-700 cursor-pointer">
    ...
    <button className="w-full bg-blue-700 text-2xl cursor-pointer text-white hover:bg-green-600 transition-colors duration-150 font-bold p-1 rounded-md">See More</button>
    </Link>
